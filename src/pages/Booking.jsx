...
import { ArrowLeft, ShieldCheck, CheckCircle2, Mail, Video, MapPin, Star, Clock, Smartphone, CreditCard } from "lucide-react";
...
export default function Booking() {
  ...
  const payLabel = payMethod === "card" ? "Card" : "M-Pesa";
      ...
      <div style={{ width: "100%", maxWidth: "560px" }}>
        ...
        <div style={card}>
          ...
          <div style={{ display: "flex", gap: "10px", marginBottom: "20px" }}>
            {[{ k: "mpesa", label: "M-Pesa", Icon: Smartphone }, { k: "card", label: "Card", Icon: CreditCard }].map((m) => (
