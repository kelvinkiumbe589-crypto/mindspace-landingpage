        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: "10px", marginTop: "20px" }}>
              <a
                href="https://x.com/thegreatkiumbes"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Follow MindSpace on X"
                style={{ width: "38px", height: "38px", borderRadius: "10px", background: "rgba(83,74,183,0.15)", border: "1px solid rgba(127,119,221,0.2)", display: "flex", alignItems: "center", justifyContent: "center", color: "#c4c1f0", textDecoration: "none" }}
              >
              ...
              <a
                href="https://www.linkedin.com/in/kelvin-kiumbe-08463b347"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Connect with MindSpace on LinkedIn"
                style={{ width: "38px", height: "38px", borderRadius: "10px", background: "rgba(83,74,183,0.15)", border: "1px solid rgba(127,119,221,0.2)", display: "flex", alignItems: "center", justifyContent: "center", color: "#c4c1f0", textDecoration: "none" }}
              >
